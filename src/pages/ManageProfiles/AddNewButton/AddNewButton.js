...
const AddNewButton = ({ onAddClick }) => {
  return (
    <div className={classes["profile-add-button-container"]} onClick={onAddClick}>
      <div className={classes["profile-add-button"]}>
        <svg viewBox="0 0 256 256" fill="currentColor" className={classes["svg-icon"]}>
      ...
      <div className={classes.title}>Add New Profile</div>
    </div>
  );
};
